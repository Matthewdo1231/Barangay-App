...
export async function createBarangayBusinessClearanceRequest(formData: FormData) {
  ...
  await prisma.request.create({
    data: {
      ...
      requestType: "BARANGAY_BUSINESS_CLEARANCE",
      details: {
  ...
  revalidatePath("/barangay-business-clearance");
  redirect("/request/barangay-business-clearance?success=1");
}
